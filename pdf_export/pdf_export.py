...
from pair import DaysOfWeek, StudentPairAttrib, SubgroupPairAttrib
import defaults
...
def export_to_pdf(schedule: Schedule, start_week, end_week):
    ...
    pdf.add_font('DejaVu', '', './pdf_export/DejaVuSansCondensed.ttf', uni=True)
    pdf.set_font('DejaVu', '')
    ...
    while True:
        ...
        pdf.cell(w, title, txt="ИДБ-17-09. Зеленый цвет - А "
                               "подгруппа, желтый цвет - Б подгруппа. "
